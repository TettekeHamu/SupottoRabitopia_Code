...
namespace PullAnimals
{
    ...
    public class RabbitCreateData : ScriptableObject
    {
        ...
        /// <summary>
        /// フィーバー時のウサギの生成位置を管理するデータの配列
        /// </summary>
        [Header("フィーバー時のウサギの生成位置を管理するデータ")]
        [SerializeField] private RabbitCreatePosData[] _feverRabbitCreatePosDataArray;
        /// <summary>
        /// ウサギの生成をおこなう時間
        /// </summary>
        ...
        /// フィーバー時のウサギの生成位置を管理するデータの配列
        /// </summary>
        public RabbitCreatePosData[] FeverRabbitCreatePosDataArray => _feverRabbitCreatePosDataArray;
        /// <summary>
        /// ウサギの生成をおこなう時間
        /// </summary>
