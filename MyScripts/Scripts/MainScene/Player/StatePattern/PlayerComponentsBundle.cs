namespace PullAnimals
{
    ...
    public class PlayerComponentsBundle
    {
        ...
        /// </summary>
        private readonly TargetRabbitUIController _targetRabbitUIController;
        ...
        /// コンストラクター
        /// </summary>
        public PlayerComponentsBundle(PlayerAnimatorController ac, PlayerMoveController mc, PlayerHandController hc, ScoreController sc, CameraController cc, 
            PlayerParticleController pc, PlayerFeverController pfc, PlayerAnimationEventConnector paec, TargetRabbitUIController truic)
        {
            ...
            _targetRabbitUIController = truic;
        }
    }
}
