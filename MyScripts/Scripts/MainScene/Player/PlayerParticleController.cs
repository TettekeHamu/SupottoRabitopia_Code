...
namespace PullAnimals
{
    ...
    public class PlayerParticleController : MonoBehaviour
    {
        ...
        {
            var feverParticleObj = Instantiate(_feverParticlePrefab, transform.position + new Vector3(0,0.2f,0), Quaternion.identity);
            feverParticleObj.transform.SetParent(transform);
