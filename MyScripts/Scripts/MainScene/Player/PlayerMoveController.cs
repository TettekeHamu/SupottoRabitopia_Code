...
namespace PullAnimals
{
    ...
    public class PlayerMoveController : MonoBehaviour
    {
        ...
        {
            //初期値を設定
            _walkSpeed = _playerMoveData.WalkSpeed;
            _runSpeed = _playerMoveData.RunSpeed;
        ...
        {
            //入力をXZ平面に変換 & 長さを1にする
            var directionVec = new Vector3(MyInputController.Instance.GetMoveInputVector2().x, 0, MyInputController.Instance.GetMoveInputVector2().y).normalized;
            ...
            //スピードを取得
            var speed = MyInputController.Instance.GetWalkKey() ? _walkSpeed : _runSpeed;
