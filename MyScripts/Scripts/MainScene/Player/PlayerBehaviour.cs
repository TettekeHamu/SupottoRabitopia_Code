...
namespace PullAnimals
{
    ...
    public class PlayerBehaviour : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField] private TargetRabbitUIController _targetRabbitUIController;
        /// <summary>
        /// ゲームのスコアを管理するクラス
        /// </summary>
        ...
        {
            //StateMachineを生成
            var bundle = new PlayerComponentsBundle(_animatorController, _playerMove, _handController, _scoreController, _cameraController, 
                _particleController, _feverController, _animationEventConnector, _targetRabbitUIController);
